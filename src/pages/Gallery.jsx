...
const GardenGallery = () => {
  return (
    <>
      <Helmet>
        <title>Galeria Realizacji | OwcaOgrody</title>
        <meta
          name="description"
          content="Zobacz zdjęcia zrealizowanych projektów, zadbanych trawników i profesjonalnych usług ogrodniczych wykonanych na Dolny Śląsk."
        />
      </Helmet>
